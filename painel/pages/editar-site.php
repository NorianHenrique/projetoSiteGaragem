...
<div class="box-content">
	...
	<form method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			<label>Descrição do serviço de limpeza :</label>
			<textarea name="servico_limpeza"><?php echo $site['servico_limpeza']; ?></textarea>
		</div><!--form-group-->

		

		<div class="form-group">
			<label>Descrição do serviço de recompra de carros:</label>
			<textarea name="servico_recompra"><?php echo $site['servico_recompra']; ?></textarea>
		</div><!--form-group-->
